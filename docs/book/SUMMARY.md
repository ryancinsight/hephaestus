...
# Part I — The Device Contract

- [1. ComputeDevice](compute_device.md)
  - [Example: Host Device](examples/host_device.md)
- [2. DeviceBuffer](device_buffer.md)
- [3. Capabilities and Limits](capabilities.md)
  - [Example: Capabilities](examples/capabilities.md)

# Part II — Operation Seams
