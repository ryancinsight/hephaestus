//! ROCm/HIP volume ray-integral dispatch.
...
pub fn ray_line_integrals_into(
    ...
    MultiStorageKernel::<RocmDevice, VolumeParams, [RocmStorageBinding<'_>; 3]>::dispatch(
        &kernel,
        device,
        [
            RocmStorageBinding::new(0, field),
            RocmStorageBinding::new(1, rays),
            RocmStorageBinding::new(2, out),
        ],
        &params,
        grid,
    )
