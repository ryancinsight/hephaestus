...
impl BunchKaufmanHandle<RocmDevice> for GpuBunchKaufmanDecomposition {
    fn order(&self) -> usize {
        self.n()
    }
    fn l_buffer(&self) -> &RocmBuffer<f32> {
        Self::l_buffer(self)
    }
    fn d_buffer(&self) -> &RocmBuffer<f32> {
        Self::d_buffer(self)
    }
    fn permutation(&self) -> &[usize] {
        Self::permutation(self)
...
impl UduHandle<RocmDevice> for GpuUduDecomposition {
    fn order(&self) -> usize {
        self.n()
    }
    fn u_buffer(&self) -> &RocmBuffer<f32> {
        Self::u_buffer(self)
    }
    fn d_buffer(&self) -> &RocmBuffer<f32> {
        Self::d_buffer(self)
...
impl SchurHandle<RocmDevice> for GpuRealSchur {
    fn order(&self) -> usize {
        self.n()
    }
    fn q_buffer(&self) -> &RocmBuffer<f32> {
        Self::q_buffer(self)
    }
    fn t_buffer(&self) -> &RocmBuffer<f32> {
        Self::t_buffer(self)
    }
}

impl HessenbergHandle<RocmDevice> for GpuHessenbergDecomposition {
    fn order(&self) -> usize {
        self.n()
    }
    fn q_buffer(&self) -> &RocmBuffer<f32> {
    ...
    fn h_buffer(&self) -> &RocmBuffer<f32> {
        Self::h_buffer(self)
    }
}

impl BidiagonalHandle<RocmDevice> for GpuBidiagonalDecomposition {
    fn shape(&self) -> (usize, usize) {
        Self::shape(self)
    }
    fn u_buffer(&self) -> &RocmBuffer<f32> {
    ...
    fn b_buffer(&self) -> &RocmBuffer<f32> {
        Self::b_buffer(self)
    }
    fn v_buffer(&self) -> &RocmBuffer<f32> {
        Self::v_buffer(self)
    }
}
